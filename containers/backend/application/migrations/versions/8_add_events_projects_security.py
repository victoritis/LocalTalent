...
def upgrade():
    ...
    op.add_column('user', sa.Column('username', sa.String(length=50), nullable=True, unique=True))
    ...
    op.add_column('user', sa.Column('push_subscription', postgresql.JSONB(), nullable=True))
